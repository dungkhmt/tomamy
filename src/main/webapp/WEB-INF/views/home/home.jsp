...
<body>
	...
	<div class="container">
	    <div class="row">
	        <div class="col-lg-12">
	            <h1 class="page-header">Hệ thống thông tin cứu trợ thiên tai</h1>
	        </div>
	        <!-- /.col-lg-12 -->
		</div>
		<!-- /.row -->
	    ...
	    <div class="row">
	    	<div class="col-sm-4">
	    		<a href="<c:url value = "/reliefdemand"/>">
		     		<div class="card">
		     			<div class="card-block">
		     				<h4 class="card-title"><b>Nhu cầu cứu trợ</b></h4>
		     			</div>
		     			<!-- /.card-block -->
		     		...
		     		<!-- /.card -->
	     				...
	     				<div class="col-sm-4">
		    	<a href="<c:url value = "/relief"/>">
		     		<div class="card">
		     			<div class="card-block">
		     				<h4 class="card-title"><b>Cứu trợ</b></h4>
		     			</div>
		     			<!-- /.card-block -->
